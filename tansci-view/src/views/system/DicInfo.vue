        ...
        <el-card>
            ...
            <el-dialog title="新增字典" v-model="addVisible" :show-close="false">
                <el-form :model="addForm" :rules="rules" ref="addRuleForm" label-position="right" label-width="100px">
                    <el-row :gutter="20">
                        ...
                        <el-col :span="12">
                            <el-form-item label="字典类型" prop="type"
                                :rules="[{ required: true, message: '字典类型不能为空', trigger: 'change' }]">
                                <el-select v-model="addForm.type" placeholder="请选择字典类型" style="width:100%">
                                    <el-option v-for="item in typeList" :key="item" :label="item.dicLabel"
                    ...
                    <el-row :gutter="20">
                        <el-col :span="12">
                            <el-form-item label="标签名" prop="dicLabel"
                        ...
                        <el-col :span="12">
                            <el-form-item label="数据值" prop="dicValue"
                                ...
                                <el-input v-model="addForm.dicValue" placeholder="请输入数据值" autocomplete="off"
                    ...
                    <el-row :gutter="20">
                        <el-col>
                            <el-form-item label="备注" prop="remarks">
                                <el-input type="textarea" v-model="addForm.remarks" placeholder="请输入备注" :rows="3"
                                    maxlength="120" show-word-limit style="width:100%"></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                </el-form>
