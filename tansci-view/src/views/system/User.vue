        ...
        <el-card>
            ...
            <el-dialog :title="userTitle" v-model="userVisible" :show-close="false">
                <el-form :model="userForm" :rules="rules" ref="userRuleForm" status-icon label-width="100px">
                    <el-row :gutter="20">
                        <el-col :span="12">
                            <el-form-item prop="username" label="用户名"
                                ...
                                <el-input v-if="operate == 1" disabled v-model="userForm.username"
                        ...
                        <el-col :span="12">
                            <el-form-item prop="type" label="类型"
                                ...
                                <el-radio-group v-model="userForm.type">
                                    <el-radio v-for="item in userTypeList" :key="item" :label="item.dicValue">{{
                                        item.dicLabel }}</el-radio>
                                </el-radio-group>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                    ...
                    <el-row :gutter="20">
                        <el-col :span="12">
                            <el-form-item v-show="operate == 0" prop="password" label="密码"
                                :rules="[
                        ...
                        <el-col :span="12">
                            <el-form-item v-show="operate == 0" prop="rePassword" label="确认密码"
                    ...
                    <el-row>
                        <el-col>
                            <el-form-item label="组织机构" prop="orgId"
                                ...
                                <el-cascader v-model="userForm.orgId" :options="orgData"
