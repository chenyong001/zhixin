        ...
        <el-card>
            <el-tabs v-model="activeName" @tab-click="onHandleClick">
                ...
                <el-tab-pane label="异常日志" name="error">
                    <Table :data="tableData" :column="tableErrorTitle" :page="page" :loading="loading"
                        :tableHeight="tableHeight" @onSizeChange="onSizeChange" @onCurrentChange="onCurrentChange"
                        @onButtonClick="onDetail">
                    </Table>
                </el-tab-pane>
            </el-tabs>
            <el-dialog v-model="detailVisible" title="日志详情" :show-close="false" width="60%">
                <el-descriptions v-if="activeName == 'info'" :column="3" border>
                    ...
                    <el-descriptions-item label-align="right" :span="3" label="操作方法">{{ detail.method
                    }}</el-descriptions-item>
