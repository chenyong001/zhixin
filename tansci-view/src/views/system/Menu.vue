<template>
    <div class="menu">
        <el-card class="menu-tree" shadow="never">
            <el-tree :data="treeData" :props="{ children: 'children', label: 'chineseName' }" accordion highlight-current
        ...
        <el-card class="menu-detail" shadow="never">
            ...
            <el-form :model="addMenuForm" :rules="rules" ref="addMenuRuleForm"
                :disabled="operate == 0 || operate == 3 ? true : false" label-position="right" label-width="150px">
                ...
                <el-form-item label="英文名称" prop="englishName">
                    <el-input v-model="addMenuForm.englishName" placeholder="请输入英文名称" autocomplete="off"
                        style="width:50%"></el-input>
                </el-form-item>
                <el-form-item label="菜单图标" prop="icon" :rules="[{ required: true, message: '菜单图标不能为空', trigger: 'blur' }]">
                    <el-input v-model="addMenuForm.icon" @click="onFormIcon" readonly suffix-icon="Platform"
                        style="width:50%"></el-input>
