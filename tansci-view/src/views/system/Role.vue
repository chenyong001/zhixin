    ...
    <div class="role">
        <el-card>
            ...
            <el-dialog :title="title" v-model="addRoleVisible" width="30%" :show-close="false">
                <el-form :model="addRoleForm" :rules="rules" ref="addRoleRuleForm" label-position="right"
                    label-width="100px">
            ...
            <el-dialog title="分配权限" v-model="roleVisible" width="30%" :show-close="false">
                <el-tree :data="roleTrees" show-checkbox node-key="id" ref="roleTree" :default-checked-keys="checkedKeys"
