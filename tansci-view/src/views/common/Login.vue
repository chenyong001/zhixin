        ...
        <div class="login-form">
          <el-form v-if="loginMode" :model="loginForm" ref="loginRuleForm">
            ...
            <el-form-item prop="password" :rules="[
              ...
              <el-input type="password" v-model="loginForm.password" prefix-icon="Lock" show-password placeholder="请输入密码"
                style="width:100%"></el-input>
            </el-form-item>
...
const loginLogo = new URL("../../assets/image/login-left.png", import.meta.url)
  .href;
    ...
    modes: [
      {
        id: 1,
        name: "微信扫码登录",
        icon: new URL("../../assets/image/icon/wechat.svg", import.meta.url)
          .href
      },
      {
        id: 2,
        name: "微博扫码登录",
        icon: new URL("../../assets/image/icon/weibo.svg", import.meta.url).href
      },
      {
        id: 3,
        name: "QQ扫码登录",
        icon: new URL("../../assets/image/icon/qq.svg", import.meta.url).href
      }
    ],
    qrcodeTitle: "",
    qrcodeUrl: "",
    ...
    .then(res => {
      if (res) {
        ...
        if (chatFlag && chatFlag == 1) {
          ...
          localStorage.removeItem("chat");
        } else if (chatFlag && chatFlag == 11) {
          window.location.href = "/index-azure";
          localStorage.removeItem("chat");
        } else if (chatFlag && chatFlag == 12) {
          window.location.href = "/index-azure-subtitle";
          localStorage.removeItem("chat");
        } else {
          console.log("========");
          // if (isMobile()) {
