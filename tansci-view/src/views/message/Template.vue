                ...
                <template #search>
                    ...
                    <div>
                        <el-select v-model="searchForm.type" placeholder="请选择字典类型" style="width:100%">
                            <el-option v-for="item in templateTypes" :key="item" :label="item.dicLabel"
                                :value="item.dicValue"></el-option>
                        </el-select>
                    </div>
                    <div>
                        <el-select v-model="searchForm.businessType" placeholder="请选择业务类型" style="width:100%">
                            <el-option v-for="item in businessTypes" :key="item" :label="item.dicLabel"
                                :value="item.dicValue"></el-option>
                        </el-select>
                    </div>
        ...
        <el-dialog :title="templateTitle" v-model="templateVisible" width="40%" :show-close="false">
            <el-form :model="templateForm" :rules="rules" ref="addRuleForm" label-position="left" label-width="100px">
                ...
                <el-form-item label="业务类型" prop="businessType"
                    :rules="[{ required: true, message: '业务类型不能为空', trigger: 'change' }]">
                ...
                <el-form-item label="模板内容" prop="content"
                    ...
                    <MsgTemplate ref="msgTemplateRef" :content="templateForm.content" @contentEvent="onContentEvent"
                        style="width:100%" />
                </el-form-item>
                <el-form-item label="申请说明" prop="remark"
                    :rules="[{ required: true, message: '申请说明不能为空', trigger: 'blur' }]">
                    <el-input v-model="templateForm.remark" type="textarea" placeholder="请输入模板申请说明" :rows="3"
                        maxlength="100" show-word-limit style="width:100%" />
                </el-form-item>
            </el-form>
            <template #footer>
