...
public class ElasticSearchClient {
     ...
     * @param obj
     */
    public void addDocument(String indexName, Object obj){
        try {
            //向索引中添加文档
            IndexRequest request = new IndexRequest();
            request.index(indexName);
     ...
     * @return
     */
    public SearchResponse getResponseByTa(String table,String value,String index){
        try {
            // 构建查询条件
            SearchSourceBuilder searchSourceBuilder = new SearchSourceBuilder();
            searchSourceBuilder.query(QueryBuilders.matchQuery(table,value));
            // 创建查询请求对象，将查询对象配置到其中
     ...
     * @param id
     */
    public GetResponse getDocumentById(String indexName, String id){
        try {
